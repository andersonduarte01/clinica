...
urlpatterns = [
    ...
    path('pagamento/atualizar_status/<int:pk>/', views.AtualizarPagamento.as_view(), name='atualizar_pagamento'),
    ...
    path('<int:pk>/<str:data>/<int:atendimento>/comprovante/pdf/', views.criar_comprovante, name='pdf_comprovate'),
]
